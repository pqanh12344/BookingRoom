...
public class RoomDAO extends AbstractDAO<Room> implements IRoomDAO{
    ...
    public List<Room> findAllByDateAndHotel(int id, String checkIn, String checkOut) {        
        String sql = "EXEC spValidRoom @check_in = ?, @check_out = ?, @hotel_id = ?";
    ...
    public Integer save(Room room) {        
        String sql = "INSERT Rooms(hotel_id, Types_id, Name, Area, Description, "
    ...
    public void update(Room room) {
        String sql = "UPDATE Rooms SET hotel_id = ?, Types_id = ?, Name = ?, Area = ?, Description = ?, "

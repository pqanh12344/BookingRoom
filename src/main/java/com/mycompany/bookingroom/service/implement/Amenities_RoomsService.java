...
import com.mycompany.bookingroom.dao.implement.Amenities_RoomsDAO;
...
public class Amenities_RoomsService implements IAmenities_RoomsService {
	...
	/*
	 * @Inject private IAmenities_RoomsDAO amenities_RoomsDAO;
	 */
	
	IAmenities_RoomsDAO amenities_RoomsDAO = new Amenities_RoomsDAO();
